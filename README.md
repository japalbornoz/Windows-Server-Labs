...
![Domain Promotion Wizard](https://github.com/japalbornoz/Windows-Server-Labs/blob/main/project-01-domain-setup/domain-promotion.png?raw=true)
---
...
- VMware Workstation Pro networking (VMnet isolation, manual IP setup)  
...
- Security hardening with GPOs  
- Backup & recovery strategies for domain controllers
